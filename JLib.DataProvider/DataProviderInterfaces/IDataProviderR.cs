...
/// <summary>
/// Provides a common way to access <see cref="IDataObject"/>s of any kind using <see cref="Guid"/> Ids.<br/>
    ...
    where TDataObject : IDataObject
{
    ...
    /// Throws an <see cref="DataProviderException.DataExceptions.EntityNotFoundException{TDataObject}"/> if it could not be found.</returns>
    /// <exception cref="DataProviderException.DataExceptions.EntityNotFoundException{TDataObject}"/>
